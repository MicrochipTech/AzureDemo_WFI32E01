...
void USBDeviceEventHandler(USB_DEVICE_EVENT event, void * pEventData, uintptr_t context) {
    APP_DATA * app_pic32mz_w1Data = (APP_DATA*) context;
    switch (event) {
...
static void wifiConnectCallback(DRV_HANDLE handle, WDRV_PIC32MZW_ASSOC_HANDLE assocHandle, WDRV_PIC32MZW_CONN_STATE currentState)
{
    switch (currentState) {
        case WDRV_PIC32MZW_CONN_STATE_DISCONNECTED:
            ...
            app_pic32mz_w1Data.appPic32mzW1State = APP_STATE_RECONNECT;
            break;
...
void APP_Initialize ( void )
{
    ...
    app_pic32mz_w1Data.appPic32mzW1State = APP_STATE_AZ_INIT;
...
void APP_Tasks ( void )
{
    ...
    {  
        ...
        case APP_STATE_AZ_INIT:
            nx_azure_init();
            
            app_pic32mz_w1Data.appPic32mzW1State = APP_STATE_MOUNT_DISK;            
        ...
        {            
            ...
            {      
                ...
                if (SYS_FS_ERROR_NO_FILESYSTEM == SYS_FS_Error())
                {
                    ...
                    app_pic32mz_w1Data.appPic32mzW1State = APP_STATE_FORMAT_DISK;                    
                }
                else
                {                    
                    app_pic32mz_w1Data.appPic32mzW1State = APP_STATE_MSD_CONNECT;
        ...
        {              
            ...
            if (app_pic32mz_w1Data.usbDeviceHandle != USB_DEVICE_HANDLE_INVALID) {
                ...
                app_pic32mz_w1Data.appPic32mzW1State = APP_STATE_CHECK_CERT_FILES;                
            } else {
                app_pic32mz_w1Data.appPic32mzW1State = APP_STATE_ERROR;
            }
            break;
        }
        ...
        case APP_STATE_CHECK_CERT_FILES:
        {     
            ...
            app_pic32mz_w1Data.appPic32mzW1State = APP_STATE_CHECK_AZURE_CFG_FILE;
        ...
        case APP_STATE_CHECK_AZURE_CFG_FILE:
        {       
            app_pic32mz_w1Data.appPic32mzW1State = APP_STATE_CHECK_WIFI_CFG_FILE;
        ...
        case APP_STATE_CHECK_WIFI_CFG_FILE:
        {                                 
            app_pic32mz_w1Data.appPic32mzW1State = APP_STATE_READ_CERT_WIFI_CLOUD_CFG_FILE;
        ...
        case APP_STATE_READ_CERT_WIFI_CLOUD_CFG_FILE:
        {
            app_pic32mz_w1Data.appPic32mzW1State = APP_STATE_INIT;                        
            if(SYS_FS_FileStat(AZURE_WIFI_CFG_FILE_NAME, &app_pic32mz_w1Data.fileStatus) == SYS_FS_RES_SUCCESS)            
            {
        ...
        {                  
            ...
            if (SYS_STATUS_READY == status) {
                app_pic32mz_w1Data.appPic32mzW1State = APP_STATE_INIT_READY;                
        ...
        {            
            ...
            if (DRV_HANDLE_INVALID != app_pic32mz_w1Data.wdrvHandle) {
                ...
                app_pic32mz_w1Data.appPic32mzW1State = APP_STATE_CHECK_CREDENTIALS;
            }
            break;
        }

        /* Check on Wi-Fi from USB MSD */
        case APP_STATE_CHECK_CREDENTIALS:
        {                       
            app_pic32mz_w1Data.appPic32mzW1State = APP_STATE_CONFIG;              
            break; 
        }
        ...
        {         
            ...
            {                
                if (WDRV_PIC32MZW_STATUS_OK == WDRV_PIC32MZW_BSSConnect(app_pic32mz_w1Data.wdrvHandle, 
                                                                        ...
                                                                        wifiConnectCallback)) 
                {
                    app_pic32mz_w1Data.appPic32mzW1State = APP_STATE_IDLE;
                    break;
                }
